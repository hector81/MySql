#6.- Se desea un informe con nombre de cliente , nombre de producto y una relación de las ventas de
...
FETCH CLIENTES_PROD INTO CLIENTE, PRODUCTO, CANTIDAD_CLIENTE,ID_PEDIDO, PRECIO;
-- EMPEZAMOS BUCLE
    ...
    SET TODO = CONCAT(TODO,CHAR(13),'CLIENTE: ' ,CLIENTE); -- IMPRIMIMOS
		...
		WHILE CLIENTE_1 = CLIENTE AND NOT COMPROBAR DO
			...
			SET TODO = CONCAT(TODO,CHAR(13),'PRODUCTO: ' ,PRODUCTO_1); -- IMPRIMIMOS
                ...
                SET ACUMULADO_PRODUCTO_CLIENTE = ACUMULADO_PRODUCTO_CLIENTE + PRECIO;-- ACUMULAMOS PRECIOS
				SET TODO= CONCAT(TODO,CHAR(13),ID_PEDIDO,SPACE(8),FORMAT(PRECIO,2));
				FETCH CLIENTES_PROD INTO CLIENTE, PRODUCTO, CANTIDAD_CLIENTE,ID_PEDIDO, PRECIO;
				END while; -- FIN BUCLE	
            SET TOTAL_VENTA_CLIENTE = TOTAL_VENTA_CLIENTE + ACUMULADO_PRODUCTO_CLIENTE; 
			SET TODO = CONCAT(TODO,CHAR(25),'TOTAL PROVEEDOR :  ', ACUMULADO_PRODUCTO_CLIENTE); -- IMPRIMIMOS				
