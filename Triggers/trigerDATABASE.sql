...
ALTER TABLE empleado
  ADD CONSTRAINT dpto FOREIGN KEY (n_dpto) REFERENCES dpto (n_Dpto) ON UPDATE CASCADE;

--
-- Filtros para la tabla 'sueldobajo'
--
ALTER TABLE sueldobajo
  ADD CONSTRAINT empleado FOREIGN KEY (id_empleado) REFERENCES empleado (id_empleado) ON UPDATE CASCADE;
