...
CREATE PROCEDURE USP_AGREGAPEDIDO( in IDPED INT, IDCLI VARCHAR(5), IDEMP INT, FECPED DATETIME, IDPROD INT, PRE DECIMAL,
CANT INT, out SALIDA varchar(100))
BEGIN
	DECLARE EXIT HANDLER FOR SQLSTATE '23000' #ES UN ERROR CON EL EXIT
	SET SALIDA='ERROR';
	...
	END$$
DELIMITER ;
CALL USP_AGREGAPEDIDO(219,'NCBCK', 1,'01-01-2014',15,10.2,1,@SALIDA);
SELECT @SALIDA;
